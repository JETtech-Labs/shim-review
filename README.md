...
Search: "JET Technology Labs Inc."
...
*******************************************************************************
Cloud based Virtual Machine Images (the SecureKey VPN and Firewall line of products) that are available in various cloud marketplaces.

*******************************************************************************
### What's the justification that this really does need to be signed for the whole world to be able to boot it?
*******************************************************************************
Shim is used to boot Virtual Machines publically available in the third party marketplace of multiple Cloud Service Providers.

*******************************************************************************
### Why are you unable to reuse shim from another distro that is already signed?
*******************************************************************************
We require a custom OS and Linux Kernel focused on security and performance, existing distros do not meet the requirements.
...
- Email: jethomas@jettechlabs.com
- PGP key fingerprint: 52e6dea25fdcc1ae38609715d55e283a674a1e34
...
- Name: Amber Thomas
- Position: Sys Admin
- Email: amber@jettechlabs.com
- PGP key fingerprint: f08dea3053f553bbc2b0dab1c58477a19cd17e2c
...
*******************************************************************************
https://github.com/JETtech-Labs/shim-review
...
* October 2023 - NTFS vulnerabilities
  ...
  * CVE-2023-4692
*******************************************************************************
Yes - GRUB2 build is v2.12 and includes SBAT "grub,4" - we do not have any previously released shim.
...
*******************************************************************************
No old shim hashes exist, this is the first submission.
Our chain only allows the current GRUB2 build.
...
*******************************************************************************
Yes all of the upstream commits are present - our Linux Kernel version is 6.12.X
...
lsm=selinux,lockdown lockdown=confidentiality

*******************************************************************************
### Do you build your signed kernel with additional local patches? What do they do?
*******************************************************************************
No. The Kernel is updated regularly using mainline (LTS) from https://github.com/torvalds/linux.

*******************************************************************************
### Do you use an ephemeral key for signing kernel modules?
### If not, please describe how you ensure that one kernel build does not load modules built for another kernel.
*******************************************************************************
Yes an ephemeral key is used to sign our kernel modules.
...
*******************************************************************************
No vendor_db is used. This shim trusts only the certificate provided in this repository using the (VENDOR_CERT_FILE=) build option. No allow-listed hashes are used.
...
*******************************************************************************
This is our first application and uses a new certificate.
...
*******************************************************************************
Yes the Dockerfile is used to reproduce the build.
...
*******************************************************************************
N/A this is our first shim build.
...
*******************************************************************************
The keys used for signing are protected using FIPS 140-2 hardware token with 
restricted access to only certified developers.
...
*******************************************************************************
boot linux ext2 fat squash4 part_msdos part_gpt normal efi_gop loadenv hashsum echo halt gcry_sha256 test regexp sleep search tpm
...
*******************************************************************************
grub-2.12.tar.xz from htp://ftp.gnu.org/gnu/grub 

sha256sum f3c97391f7c4eaa677a78e090c7e97e6dc47b16f655f04683ebd37bef7fe0faa  grub-2.12.tar.xz

*******************************************************************************
### If your shim launches any other components apart from your bootloader, please provide further details on what is launched.
Hint: The most common case here will be a firmware updater like fwupd.
*******************************************************************************
This shim launches GRUB2 only
...
*******************************************************************************
GRUB2 launches the Linux Kernel only
...
*******************************************************************************
GRUB2 verifies signatures on booted kernels.

The Linux Kernel strictly enforces signed kernel modules (CONFIG_MODULE_SIG_FORCE=y) and has lockdown enabled.

The Linux kernel's Integrity Measurement Architecture is used to authenticate all executables.
...
*******************************************************************************
Kernel is v6.12.X
CONFIG_MODULE_SIG_FORCE=y, kernel command line contains module.sig_enforce=1
CONFIG_SECURITY_LOCKDOWN_LSM=y
CONFIG_SECURITY_LOCKDOWN_LSM_EARLY=y
...
*******************************************************************************
We hope to peer-review in the near future - after completing the process first so we learn how it is done.
